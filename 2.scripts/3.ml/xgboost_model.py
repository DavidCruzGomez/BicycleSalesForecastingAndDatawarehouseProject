...
model = XGBRegressor(n_estimators=100, random_state=18)
...
grid_search = GridSearchCV(
    estimator=XGBRegressor(random_state=18),
    param_grid=param_grid,
    cv=5, # Divide in 5 parts
